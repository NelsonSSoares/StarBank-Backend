...
public class JwtTokenProvider {
    ...
    public TokenDTO refreshToken(String refreshToken){
        ...
        if (refreshTokenCotainsBearer(refreshToken)){
    ...
    public String resolveToken(HttpServletRequest request) {
        ...
        if (refreshTokenCotainsBearer(bearerToken)) {
    ...
    private static boolean refreshTokenCotainsBearer(String refreshToken) {
        return StringUtils.isNoneBlank(refreshToken) && refreshToken.startsWith("Bearer ");
    }
